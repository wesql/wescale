...
| 命令动作                | 参数                     | 描述                                                                                                                                                                                                                                                                                                                                                                            | 默认值       | 必需    |
|------------------------|-------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|----------|
| `Branch create`        | `name`                  | 分支的名称                                                                                                                                                                                                                                                                                                                                                                       | my_branch    | 否       |
...
| `Branch diff`          | `name`                  | 分支的名称                                                                                                                                                                                                                                                                                                                                                                       | my_branch    | 否       |
...
| `Branch prepare_merge_back` | `name`           | 分支的名称                                                                                                                                                                                                                                                                                                                                                                       | my_branch    | 否       |
| `Branch merge_back`    | `name`                  | 分支的名称                                                                                                                                                                                                                                                                                                                                                                       | my_branch    | 否       |
| `Branch show`          | `name`                  | 分支的名称                                                                                                                                                                                                                                                                                                                                                                       | my_branch    | 否       |
|                        | `show_option`           | 显示选项。应为`status`、`snapshot`、`merge_back_ddl`之一。                                                                                                                                                                                                                                                                                                                      | status        | 否       |
| `Branch delete`        | `name`                  | 分支的名称                                                                                                                                                                                                                                                                                                                                                                       | my_branch    | 否       |
