...
for binary in vttestserver mysqlctl mysqlctld topo2topo vtaclcheck vtbench vtclient vtctl vtctldclient vtctlclient vtctld vtexplain vtgate vttablet vtorc zk zkctl zkctld; do
