...
import (
	...
	"github.com/wesql/wescale/go/vt/vttablet/onlineddl"
	"github.com/wesql/wescale/go/vt/vttablet/queryservice"
	"github.com/wesql/wescale/go/vt/vttablet/tabletserver/gc"
	"github.com/wesql/wescale/go/vt/vttablet/tabletserver/messager"
	"github.com/wesql/wescale/go/vt/vttablet/tabletserver/planbuilder"
	"github.com/wesql/wescale/go/vt/vttablet/tabletserver/repltracker"
	...
	"github.com/wesql/wescale/go/vt/vttablet/tabletserver/txserializer"
	"github.com/wesql/wescale/go/vt/vttablet/tabletserver/txthrottler"
...
func (tsv *TabletServer) onlineDDLExecutorToggleTableBuffer(bufferingCtx context.Context, tableName string, bufferQueries bool) {
	...
	if bufferQueries {
		...
		bufferRules.Add(rules.NewActiveBufferedTableQueryRule(bufferingCtx, tableName, "buffered for cut-over"))
