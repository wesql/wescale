...
import (
	...
	"github.com/wesql/wescale/go/vt/callinfo/fakecallinfo"
...
func _TestQueryExecutorDenyListQRRetry(t *testing.T) {
	db := setUpQueryExecutorTest(t)
	defer db.Close()
...
func newTestTabletServer(_ context.Context, flags executorFlags, db *fakesqldb.DB) *TabletServer {
