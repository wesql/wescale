...
func (f *FakeQueryService) SubmitDMLJob(ctx context.Context, command, sql, uuid, tableSchema string, timeGapInMs, batchSize int64, postponeLaunch, autoRetry bool) (*sqltypes.Result, error) {
	panic("implement me")
}
