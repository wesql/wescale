...
func registerVReplicationFlags(fs *pflag.FlagSet) {
	...
	fs.BoolVar(&vreplicationStoreCompressedGTID, "vreplication_store_compressed_gtid", vreplicationStoreCompressedGTID, "Store compressed gtids in the pos column of mysql.vreplication")
