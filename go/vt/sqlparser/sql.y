...
%token <str> VGTID_EXECUTED VITESS_KEYSPACES VITESS_METADATA VITESS_MIGRATIONS VITESS_REPLICATION_STATUS VITESS_SHARDS VITESS_TABLETS VITESS_TARGET VSCHEMA VITESS_THROTTLED_APPS WORKLOAD LASTSEENGTID FAILPOINTS TABLETS_PLANS
%token <str> DML_JOBS
...
|  ALTER comment_opt VITESS_MIGRATION STRING PAUSE
  {
    $$ = &AlterMigration{
...
| ALTER comment_opt VITESS_MIGRATION PAUSE ALL
  {
    $$ = &AlterMigration{
...
| SHOW LASTSEENGTID
  {
    $$ = &Show{&ShowBasic{Command: LastSeenGTID}}
  }
| SHOW FAILPOINTS
  {
    $$ = &Show{&ShowBasic{Command: FailPoints}}
  }
...
| SHOW TABLETS_PLANS like_or_where_opt
  {
    $$ = &Show{&ShowBasic{Command: TabletsPlans, Filter: $3}}
  }
| SHOW VITESS_TARGET
  {
...
| SHOW WORKLOAD
  {
    $$ = &Show{&ShowBasic{Command: Workload}}
  }
/*
