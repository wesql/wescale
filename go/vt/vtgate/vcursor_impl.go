...
type iExecute interface {
	...
	SubmitDMLJob(command, sql, uuid, tableSchema, timePeriodStart, timePeriodEnd string, timeGapInMs, batchSize int64, postponeLaunch bool, autoRetry string) (*sqltypes.Result, error)
}
