...
type ExecuteOptions struct {
	...
	ReadAfterWriteTimeout float32 `protobuf:"fixed32,16,opt,name=ReadAfterWriteTimeout,proto3" json:"ReadAfterWriteTimeout,omitempty"`
}
...
func (x *ExecuteOptions) GetReadAfterWriteTimeout() float32 {
	if x != nil {
...
var file_query_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x74, 0x18, 0x10, 0x20, 0x01, 0x28, 0x02, 0x52, 0x15, 0x52, 0x65, 0x61, 0x64, 0x41,
