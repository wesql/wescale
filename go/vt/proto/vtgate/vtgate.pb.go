...
type ReadAfterWriteScope int32

const (
	// NONE uses the read after write scope set by the VTGate flag 'read_after_write_scope'.
	ReadAfterWriteScope_NONE ReadAfterWriteScope = 0
	// SESSION is used to designate session read after write scope.
	ReadAfterWriteScope_SESSION ReadAfterWriteScope = 1
	// INSTANCE is used to designate instance read after write scope.
	ReadAfterWriteScope_INSTANCE ReadAfterWriteScope = 2
)

// Enum value maps for ReadAfterWriteScope.
var (
	ReadAfterWriteScope_name = map[int32]string{
		0: "NONE",
		1: "SESSION",
		2: "INSTANCE",
	}
	ReadAfterWriteScope_value = map[string]int32{
		"NONE":     0,
		"SESSION":  1,
		"INSTANCE": 2,
	}
...
func (x ReadAfterWriteScope) Enum() *ReadAfterWriteScope {
	p := new(ReadAfterWriteScope)
	*p = x
	return p
}

func (x ReadAfterWriteScope) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ReadAfterWriteScope) Descriptor() protoreflect.EnumDescriptor {
	return file_vtgate_proto_enumTypes[2].Descriptor()
}

func (ReadAfterWriteScope) Type() protoreflect.EnumType {
	return &file_vtgate_proto_enumTypes[2]
}

func (x ReadAfterWriteScope) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ReadAfterWriteScope.Descriptor instead.
func (ReadAfterWriteScope) EnumDescriptor() ([]byte, []int) {
...
type ReadAfterWrite struct {
	...
	ReadAfterWriteScope   ReadAfterWriteScope `protobuf:"varint,4,opt,name=read_after_write_scope,json=readAfterWriteScope,proto3,enum=vtgate.ReadAfterWriteScope" json:"read_after_write_scope,omitempty"`
}
...
func (x *ReadAfterWrite) GetReadAfterWriteScope() ReadAfterWriteScope {
	if x != nil {
		return x.ReadAfterWriteScope
	}
	return ReadAfterWriteScope_NONE
}
...
var file_vtgate_proto_rawDesc = []byte{
	...
	0x04, 0x22, 0xfe, 0x01, 0x0a, 0x0e, 0x52, 0x65, 0x61, 0x64, 0x41, 0x66, 0x74, 0x65, 0x72, 0x57,
	...
	0x12, 0x50, 0x0a, 0x16, 0x72, 0x65, 0x61, 0x64, 0x5f, 0x61, 0x66, 0x74, 0x65, 0x72, 0x5f, 0x77,
	0x72, 0x69, 0x74, 0x65, 0x5f, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e,
	0x32, 0x1b, 0x2e, 0x76, 0x74, 0x67, 0x61, 0x74, 0x65, 0x2e, 0x52, 0x65, 0x61, 0x64, 0x41, 0x66,
	0x74, 0x65, 0x72, 0x57, 0x72, 0x69, 0x74, 0x65, 0x53, 0x63, 0x6f, 0x70, 0x65, 0x52, 0x13, 0x72,
	0x65, 0x61, 0x64, 0x41, 0x66, 0x74, 0x65, 0x72, 0x57, 0x72, 0x69, 0x74, 0x65, 0x53, 0x63, 0x6f,
	0x70, 0x65, 0x22, 0xaa, 0x01, 0x0a, 0x0e, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x52, 0x65,
	...
	0x10, 0x03, 0x2a, 0x3a, 0x0a, 0x13, 0x52, 0x65, 0x61, 0x64, 0x41, 0x66, 0x74, 0x65, 0x72, 0x57,
	0x72, 0x69, 0x74, 0x65, 0x53, 0x63, 0x6f, 0x70, 0x65, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e,
	0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x07, 0x53, 0x45, 0x53, 0x53, 0x49, 0x4f, 0x4e, 0x10, 0x01,
	0x12, 0x0c, 0x0a, 0x08, 0x49, 0x4e, 0x53, 0x54, 0x41, 0x4e, 0x43, 0x45, 0x10, 0x02, 0x42, 0x36,
...
var file_vtgate_proto_goTypes = []interface{}{
	...
	(ReadAfterWriteScope)(0),           // 2: vtgate.ReadAfterWriteScope
...
var file_vtgate_proto_depIdxs = []int32{
	...
	2,  // 11: vtgate.ReadAfterWrite.read_after_write_scope:type_name -> vtgate.ReadAfterWriteScope
