...
func (c *queryClient) ExecuteInternal(ctx context.Context, in *query.ExecuteRequest, opts ...grpc.CallOption) (*query.ExecuteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/queryservice.Query/ExecuteInternal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_ExecuteInternal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(QueryServer).ExecuteInternal(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/queryservice.Query/ExecuteInternal",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).ExecuteInternal(ctx, req.(*query.ExecuteRequest))
	}
