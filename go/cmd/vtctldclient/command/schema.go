...
--ddl-strategy is used to instruct migrations via vreplication with optional parameters.
...
func init() {
	...
	ApplySchema.Flags().StringVar(&applySchemaOptions.DDLStrategy, "ddl-strategy", string(schema.DDLStrategyDirect), "Online DDL strategy, compatible with @@ddl_strategy session variable.")
