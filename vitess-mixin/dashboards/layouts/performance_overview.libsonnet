  ...
  grafanaDashboards+:: {
    'performance_overview.json':
      ...
      .addPanels([
        ...
        //todo add vttablet duration

        # Requests (VTGate)
        rows.RequestsVTGate.addPanels([
          helpers.vtgate.getPanel(config.vtgate.panels.vtgateRequestsByInstance) { gridPos: { h: 7, w: 8, x: 0, y: 24 } },
          helpers.vtgate.getPanel(config.vtgate.panels.vtgateRequestsByDBType) { gridPos: { h: 7, w: 8, x: 8, y: 24 } },
          helpers.vtgate.getPanel(config.vtgate.panels.vtgateRequestsByKeyspace) { gridPos: { h: 7, w: 8, x: 16, y: 24 } },
        ]) { gridPos: { h: 1, w: 24, x: 0, y: 7 } },

        # Requests (VTTablet)
        rows.RequestsVTTablet.addPanels([
          helpers.vttablet.getPanel(config.vttablet.panels.vttabletRequestsByInstance) { gridPos: { h: 7, w: 8, x: 0, y: 24 } },
          helpers.vttablet.getPanel(config.vttablet.panels.vttabletRequestsByPlanType) { gridPos: { h: 7, w: 8, x: 8, y: 24 } },
          helpers.vttablet.getPanel(config.vttablet.panels.vttabletRequestsByTable) { gridPos: { h: 7, w: 8, x: 16, y: 24 } },
        ]) { gridPos: { h: 1, w: 24, x: 0, y: 14 } },

        # Duration (VTGate)
        rows.DurationVTGate.addPanels([
        ...
        # Duration (VTTablet Query)
        rows.DurationVTTabletQuery.addPanels([
          helpers.vttablet.getPanel(config.vttablet.panels.vttabletQueryDurationAvgByInstance) { gridPos: { h: 7, w: 8, x: 0, y: 58 } },
          helpers.vttablet.getPanel(config.vttablet.panels.vttabletQueryDurationP50ByInstance) { gridPos: { h: 7, w: 8, x: 8, y: 58 } },
          helpers.vttablet.getPanel(config.vttablet.panels.vttabletQueryDurationP95ByInstance) { gridPos: { h: 7, w: 8, x: 16, y: 58 } },
        ]) { gridPos: { h: 1, w: 24, x: 0, y: 28 } },

        # Duration (VTTablet Transaction)
        rows.DurationVTTabletTransaction.addPanels([
          helpers.vttablet.getPanel(config.vttablet.panels.vttabletTransactionDurationAvgByInstance) { gridPos: { h: 7, w: 8, x: 0, y: 58 } },
          helpers.vttablet.getPanel(config.vttablet.panels.vttabletTransactionDurationP50ByInstance) { gridPos: { h: 7, w: 8, x: 8, y: 58 } },
          helpers.vttablet.getPanel(config.vttablet.panels.vttabletTransactionDurationP95ByInstance) { gridPos: { h: 7, w: 8, x: 16, y: 58 } },
        ]) { gridPos: { h: 1, w: 24, x: 0, y: 35 } },

        # vtgate errors 
        rows.ErrorsVTGate.addPanels([
        ...
        # GC Misc
        rows_helper.getRow(config.row.gc).addPanels([
