    ...
    'performance_overview.json':
      ...
      .addPanels([
        ...
        rows.duration.addPanels([
          ...
          helpers.vtgate.getPanel(config.vtgate.panels.vtgateDurationP50) { gridPos: { h: 7, w: 8, x: 8, y: 58 } },//todo support mysql duration
          helpers.vtgate.getPanel(config.vtgate.panels.vtgateDurationP95) { gridPos: { h: 7, w: 8, x: 16, y: 58 } },//todo support mysql duration
